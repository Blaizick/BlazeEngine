...
public unsafe class ImGui
{
    ...
    [DllImport("ImGui.dll", EntryPoint = "ImGui_IsKeyPressed")]
    public static extern bool IsKeyPressed(ImGuiKey key, bool repeat = true);
    [DllImport("ImGui.dll", EntryPoint = "ImGui_IsKeyDown")]
    public static extern bool IsKeyDown(ImGuiKey key);
    [DllImport("ImGui.dll", EntryPoint = "ImGui_IsKeyReleased")]
    public static extern bool IsKeyReleased(ImGuiKey key);
    
    [DllImport("ImGui.dll", EntryPoint = "ImGui_IsMouseClicked")]
    public static extern bool IsMouseClicked(ImGuiMouseButton button, bool repeat = true);
    [DllImport("ImGui.dll", EntryPoint = "ImGui_IsMouseDown")]
    public static extern bool IsMouseDown(ImGuiMouseButton button);
    [DllImport("ImGui.dll", EntryPoint = "ImGui_IsMouseReleased")]
    public static extern bool IsMouseReleased(ImGuiMouseButton button);
    
    [DllImport("ImGui.dll", EntryPoint = "ImGui_SetKeyboardFocusHere")]
    public static extern bool SetKeyboardFocusHere(int offset = 0);
}
