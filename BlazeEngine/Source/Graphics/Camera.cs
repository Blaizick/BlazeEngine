...
public class Camera
{
    ...
    public Camera(float x, float y, float size, float r)
    {
        ...
        WindowInstance.onResize += Recalculate;
    }
    ...
    {
        Camera.WindowInstance = windowInstance;
    }
    ...
    public void Recalculate()
    {
        ...
        {
            float hw = WindowInstance.Size.X / PixelsPerInit * 0.5f;
            float hh = WindowInstance.Size.Y / PixelsPerInit * 0.5f;
    ...
    {
        Vec2 ndc = new Vec2(point.X / WindowInstance.Size.X * 2 - 1, (WindowInstance.Size.Y - point.Y) / WindowInstance.Size.Y * 2 - 1);
